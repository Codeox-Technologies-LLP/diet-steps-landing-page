...
import "../App.css";
import mobile from "../assets/lots of cards yellow violet.png";

import img from "../assets/lots of cards yellow violet.png";
      ...
      <section style={{ backgroundColor: "#f3f3f3" }}>
        ...
        >
          <div style={{ position: "relative" }}>
            <img className="privacyhero-img" src={img} alt="Privacy Hero" />
            ...
            <div className="">
              ...
              <div>
                ...
                <div>
                  ...
                  <ul>
                    <li>
                      <strong>Mobile Application</strong> refers to Dietstp and StepsDriver, the
                  ...
                  <ul>
                    <li>
                      ...
                      Dietstp Kuwait LLC, Dietstp Kuwait LLC .
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      <strong>Country</strong> refers to : Kuwait
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      <strong>Website</strong> refers to Dietstp kuwait ,
                      accessible from www.Dietkuwait.com
                    </li>
                  </ul>
            ...
            <br />
              ...
              <div>
                ...
                <ul>
                  <li>
                    ...
                    on the Free Privacy Policy website article.
                  </li>
                  <br />
                  <li>
              ...
              <div>
                ...
                <ul>
                  <li>
                    {" "}
                    <strong> With other users : </strong> You share personal
              ...
              <div>
                <ul>
                  <li>
                    <h3>
                      <strong>Disclosure and Security of Personal Data</strong>
                    </h3>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul>
                  <li> By email: info@Diet stepskuwait.com</li>
                </ul>
                <ul>
                  <li>
                    By visiting this page on our website:{" "}
                    <a
                      href="http://diet-steps.code-ox.com/"
                      target="_blank"
                      rel="noreferrer"
                      style={{ textDecoration: "none", color: "black" }}
                    >
                      http://diet-steps.code-ox.com/
                    </a>
                  </li>
                </ul>
              </div>
